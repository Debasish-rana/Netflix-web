...
updateProfile(user, {
  ...
  return (
    <div>
      ...
      <from
        className="absolute p-16 bg-black m-auto left-0 right-0 md:w-3/12 w-50% mt-52 bg-opacity-70 "
        onSubmit={(event) => {
      ...
      >
        ...
        {signBtn === "Sign Up" ? (
          <input
            ...
            className="p-2 border-none w-full my-4 bg-slate-800 text-white"
          />
        ) : (
          <div></div>
        )}
